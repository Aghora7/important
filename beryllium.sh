git clone https://github.com/aghora7/device_xiaomi_beryllium -b twelve device/xiaomi/beryllium
git clone https://github.com/XtremeOrnob/xiaomi_sdm845-common -b aosp-12 device/xiaomi/sdm845-common
git clone https://github.com/XtremeOrnob/XDKernel kernel/xiaomi/sdm845
git clone https://github.com/XtremeOrnob/vendor_xiaomi.git -b aosp-12 vendor/xiaomi
